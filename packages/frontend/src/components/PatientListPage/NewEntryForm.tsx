...
import { TextField, InputLabel, MenuItem, InputAdornment, Select, Grid, Button, SelectChangeEvent } from '@mui/material'
  ...
  return (
    <div>
      <form onSubmit={onFormSubmit}>
        ...
        <Select label='Type' fullWidth value={visitType} onChange={onTypeChange}>
        ...
        <div id='hospital' style={{ display: visitType === 'Hospital' ? '' : 'none' }}>
          ...
          />
          <TextField label='Discharge criteria' fullWidth value={HDC} onChange={({ target }) => setHDC(target.value)} />
        </div>
        <div id='healthcheck' style={{ display: visitType === 'HealthCheck' ? '' : 'none' }}>
          <Select label='Type' fullWidth value={HealthCheckRating} onChange={onHealthCheckRatingChange}>
        ...
        <div id='occupational' style={{ display: visitType === 'OccupationalHealthcare' ? '' : 'none' }}>
          <TextField label='Employer' fullWidth value={employer} onChange={({ target }) => setEmployer(target.value)} />
          <p></p>
          <TextField
            label='Leave start'
            InputProps={{
